...
대화의 품질을 알려주기 위해 사용된 어휘의 개수, Distinct n-gram, perplexity 등의 평가 기준을 적용했으며, 추천의 효과 및 효율은 Precision과 함께 감정 분석을 통해 성공적인 추천인지 판별하여 통계치를 제공했다.
...
- 이번 프로젝트를 통해 비로소 나는 깃허브를 제대로 활용하는 법을 익힐 수 있었다.
...
Log 관리, A/B Test, ETL, 세션 관리 등 다음 프로젝트에서 해보고 싶은 것들이 더 많아지게 됐다.
